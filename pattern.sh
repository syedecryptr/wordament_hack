...
COL_1=180                   # X coordinate of column 1 (in pixels)
COL_2=544                   # X coordinate of column 2 (in pixels)
COL_3=895                   # X coordinate of column 3 (in pixels)

ROW_1=707                   # Y coordinate of row 1 (in pixels)
ROW_2=1068                   # Y coordinate of row 2 (in pixels)
ROW_3=1425                   # Y coordinate of row 3 (in pixels)
...
StartTouch() {
adb shell sendevent /dev/input/event2 0003 57 161
adb shell sendevent /dev/input/event2 0001 330 0
adb shell sendevent /dev/input/event2 0001 325 0
adb shell sendevent /dev/input/event2 0003 53 38
adb shell sendevent /dev/input/event2 0003 54 53
adb shell sendevent /dev/input/event2 0003 48 0
adb shell sendevent /dev/input/event2 0000 0 0
adb shell sendevent /dev/input/event2 0003 57 268435455
adb shell sendevent /dev/input/event2 0001 330 0
adb shell sendevent /dev/input/event2 0001 325 0
adb shell sendevent /dev/input/event2 0000 0 0
}
...
FinishTouch() {
	adb shell sendevent /dev/input/event2 3 57 268435455
	adb shell sendevent /dev/input/event2 0 0 0
}
